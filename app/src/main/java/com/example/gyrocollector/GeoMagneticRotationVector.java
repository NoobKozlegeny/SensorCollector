...
public class GeoMagneticRotationVector {
    ...
    // create an instance
    private GeoMagneticRotationVector.Listener listener;

    // method to set the instance
    public void setListener(GeoMagneticRotationVector.Listener l) {
        listener = l;
    }
        ...
        sensorEventListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                if (listener != null) {
                    ...
                    if (!MainActivity.hasGeoMagneticRotation.equals(true)) {
                        ...
                        gmrvList.add(sensorEvent.values[0] + "," + sensorEvent.values[1] + "," + sensorEvent.values[2]);
