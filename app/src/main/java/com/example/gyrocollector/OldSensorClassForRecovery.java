...
public class OldSensorClassForRecovery {
    ...
    // create an instance
    private OldSensorClassForRecovery.Listener listener;

    // method to set the instance
    public void setListener(OldSensorClassForRecovery.Listener l) {
        listener = l;
    }

    //Constructor
    OldSensorClassForRecovery(Context context, SensorManager sensorManager)
    {
